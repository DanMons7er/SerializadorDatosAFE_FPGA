...
_io = [
    ...
    # I2C
    ("i2c", 0,
        Subsignal("scl", Pins("W5"), IOStandard("LVCMOS33")),
        Subsignal("sda", Pins("V5"), IOStandard("LVCMOS33")),
    ),

    # AudioCodec
    ("audioCodec", 0,
        Subsignal("adc_sdata", Pins("T4")),
        Subsignal("bclk", Pins("T5")),
        Subsignal("dac_sdata", Pins("W6")),
        Subsignal("lrclk", Pins("U5")),
        Subsignal("mclk", Pins("U6")),
        IOStandard("LVCMOS33"),
    ),
    ...
    ("afe", 0, 
        Subsignal("fclkp", Pins("C14"),IOStandard("LVDS_25")),
        Subsignal("fclkn", Pins("C15"),IOStandard("LVDS_25")),
        Subsignal("dclkp", Pins("C18"),IOStandard("LVDS_25")),
        Subsignal("dclkn", Pins("C19"),IOStandard("LVDS_25")),
        Subsignal("datap", Pins("E19 E21 B21 B15 F16 F18 B20 C13"),IOStandard("LVDS_25")),
        Subsignal("datan", Pins("D19 D21 A21 B16 E17 E18 A20 B13"),IOStandard("LVDS_25")),
...
class Platform(XilinxPlatform):
    ...
    def __init__(self, toolchain="vivado"):
        ...
        self.add_platform_command("set_property INTERNAL_VREF 0.9 [get_iobanks 16]")

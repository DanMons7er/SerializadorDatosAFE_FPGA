...
set_property -dict { CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN } [get_nets { Mux_inst/OA }]; #Mux_inst/MuxB_ints/OB
set_property -dict { CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN } [get_nets { Mux_inst/OB }]; #Mux_inst/MuxA_ints/
set_property -dict { CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN } [get_nets { Mux_inst/MuxC_ints/O }]; #Mux_inst/MuxC_ints/


## LEDs
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS25 } [get_ports { showRegInLED[0] }]; #IO_L15P_T2_DQS_13 Sch=led[0]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS25 } [get_ports { showRegInLED[1] }]; #IO_L15N_T2_DQS_13 Sch=led[1]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS25 } [get_ports { showRegInLED[2] }]; #IO_L17P_T2_13 Sch=led[2]
...
#set_property -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS12 } [get_ports { SW2 }]; #IO_L24P_T3_16 Sch=sw[2]

...
HD_PWD='C:/Tesis/Versiones/TesisV3/SERDES_EM/SERDES_EM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainInstantiation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainInstantiation.tcl

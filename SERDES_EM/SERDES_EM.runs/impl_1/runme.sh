...
HD_PWD='C:/Tesis/Versiones/TesisV3/SERDES_EM/SERDES_EM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mainInstantiation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mainInstantiation.tcl -notrace

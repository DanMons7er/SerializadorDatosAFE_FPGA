...
#set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets Mux_inst/MuxB_ints/OB]
#set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets Mux_inst/MuxA_ints/OA]
#set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets Mux_inst/MuxC_ints/O]


## LEDs
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS25 } [get_ports { led1 }]; #IO_L15P_T2_DQS_13 Sch=led[0]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS25 } [get_ports { led2 }]; #IO_L15N_T2_DQS_13 Sch=led[1]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS25 } [get_ports { led3 }]; #IO_L17P_T2_13 Sch=led[2]
#set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS25 } [get_ports { showRegInLED[3] }]; #IO_L17N_T2_13 Sch=led[3]
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS25 } [get_ports { showRegInLED[4] }]; #IO_L14N_T2_SRCC_13 Sch=led[4]
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS25 } [get_ports { showRegInLED[5] }]; #IO_L16N_T2_13 Sch=led[5]
#set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS25 } [get_ports { showRegInLED[6] }]; #IO_L16P_T2_13 Sch=led[6]
#set_property -dict { PACKAGE_PIN Y13   IOSTANDARD LVCMOS25 } [get_ports { showRegInLED[7] }]; #IO_L5P_T0_13 Sch=led[7]


## Buttons
#set_property -dict { PACKAGE_PIN B22 IOSTANDARD LVCMOS12 } [get_ports { RST_BTNC }]; #IO_L20N_T3_16 Sch=btnc
...
## Switches
set_property -dict { PACKAGE_PIN E22  IOSTANDARD LVCMOS12 } [get_ports { sw1 }]; #IO_L22P_T3_16 Sch=sw[0]
set_property -dict { PACKAGE_PIN F21  IOSTANDARD LVCMOS12 } [get_ports { sw2 }]; #IO_25_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS12 } [get_ports { sw3 }]; #IO_L24P_T3_16 Sch=sw[2]
#set_property -dict { PACKAGE_PIN G22  IOSTANDARD LVCMOS12 } [get_ports { StandBySW }]; #IO_L24N_T3_16 Sch=sw[3]
#set_property -dict { PACKAGE_PIN H17  IOSTANDARD LVCMOS12 } [get_ports { GetInputControl }]; #IO_L6P_T0_15 Sch=sw[4]
...
## FMC
#set_property -dict { PACKAGE_PIN H19    IOSTANDARD LVDS_25 } [get_ports { frameInputN }]; #IO_L12N_T1_MRCC_15 Sch=fmc_clk0_m2c_n
#set_property -dict { PACKAGE_PIN J19    IOSTANDARD LVDS_25 } [get_ports { frameInputP }]; #IO_L12P_T1_MRCC_15 Sch=fmc_clk0_m2c_p
#set_property -dict { PACKAGE_PIN C19    IOSTANDARD LVDS_25 } [get_ports { inputClockN }]; #IO_L13N_T2_MRCC_16 Sch=fmc_clk1_m2c_n
#set_property -dict { PACKAGE_PIN C18    IOSTANDARD LVDS_25 } [get_ports { inputClockP }]; #IO_L13P_T2_MRCC_16 Sch=fmc_clk1_m2c_p
...
#set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVDS_25 } [get_ports { Data_N }]; #IO_L14N_T2_SRCC_16 Sch=fmc_la_n[21]
#set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVDS_25 } [get_ports { Data_P }]; #IO_L14P_T2_SRCC_16 Sch=fmc_la_p[21]
